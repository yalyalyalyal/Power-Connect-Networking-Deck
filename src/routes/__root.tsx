...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pre-release: Power Connect | Energy Tech Week | Ignite The" },
      ...
      { property: "og:title", content: "Pre-release: Power Connect | Energy Tech Week | Ignite The" },
      { name: "twitter:title", content: "Pre-release: Power Connect | Energy Tech Week | Ignite The" },
