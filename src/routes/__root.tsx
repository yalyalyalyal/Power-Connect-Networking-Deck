...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Test Version: Power Connect | Energy Tech Week | Ignite The" },
      ...
      { property: "og:title", content: "Test Version: Power Connect | Energy Tech Week | Ignite The" },
      { name: "twitter:title", content: "Test Version: Power Connect | Energy Tech Week | Ignite The" },
