...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Test Version: ETW | Power Connect" },
      { name: "description", content: "ETW Connect Deck is a mobile networking app for Energy Tech Week 2026 attendees." },
      { name: "theme-color", content: "#141040" },
      { property: "og:title", content: "Test Version: ETW | Power Connect" },
      { name: "twitter:title", content: "Test Version: ETW | Power Connect" },
      { property: "og:description", content: "ETW Connect Deck is a mobile networking app for Energy Tech Week 2026 attendees." },
      { name: "twitter:description", content: "ETW Connect Deck is a mobile networking app for Energy Tech Week 2026 attendees." },
